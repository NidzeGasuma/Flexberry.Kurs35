...
namespace IIS.Kurs3
{
    ...
    public class ЭксФайлы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kurs3.ЕдиИзм fЕдиИзм;
        
        private IIS.Kurs3.Расширение fРасширение;
        ...
        [PropertyStorage(new string[] {
                "ЕдиИзм"})]
        [NotNull()]
        public virtual IIS.Kurs3.ЕдиИзм ЕдиИзм
        {
            get
            {
                ...
                IIS.Kurs3.ЕдиИзм result = this.fЕдиИзм;
        ...
        [PropertyStorage(new string[] {
                "Расширение"})]
        [NotNull()]
        public virtual IIS.Kurs3.Расширение Расширение
        {
            get
            {
                ...
                IIS.Kurs3.Расширение result = this.fРасширение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЭксФайлыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЭксФайлыE", typeof(IIS.Kurs3.ЭксФайлы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЭксФайлыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЭксФайлыL", typeof(IIS.Kurs3.ЭксФайлы));
                }
            }
        }
    }
