...
namespace IIS.Kurs3
{
    ...
    [View("КонвертацияE", new string[] {
            ...
            "ЗагрФайла.Дата as \'Дата\'",
            "ЗагрФайла.ЭксФайлы.Имя as \'Имя файла\'",
            "ИмяДок as \'Имя документа\'",
            "НастрКонв as \'Настройка\'",
            "НастрКонв.Наименование as \'Наименование\'"}, Hidden=new string[] {
            "ЗагрФайла.Дата",
            "НастрКонв.Наименование"})]
    [MasterViewDefineAttribute("КонвертацияE", "ЗагрФайла", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Дата")]
    ...
    [View("КонвертацияL", new string[] {
            ...
            "НастрКонв.Наименование as \'Наименование\'"})]
    public class Конвертация : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонвертацияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонвертацияE", typeof(IIS.Kurs3.Конвертация));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонвертацияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонвертацияL", typeof(IIS.Kurs3.Конвертация));
                }
            }
        }
    }
